...
// 新增数据及配置项
func Add(name, data interface{}, options ...seriesOptser) *Parallel
// 新增 JS 函数
...
平行坐标系需要配置 `ParallelChart Options`，配置项详细参数可参考 [全局配置项#ParallelChart Options](/docs/global_options#parallelchart-options)
...
```
![](https://user-images.githubusercontent.com/19553554/52535013-e48e2f80-2d83-11e9-8886-ac0d2122d6af.png)
...
parallel.Add("北京", parallelDataBJ)
```
![](https://user-images.githubusercontent.com/19553554/52535014-f2dc4b80-2d83-11e9-8119-e5cf832d9c14.png)
...
// 或者直接使用 parallel.ParallelAxisOpts 赋值
...
```
![](https://user-images.githubusercontent.com/19553554/52535018-fe2f7700-2d83-11e9-9780-ce9018250a6f.png)
