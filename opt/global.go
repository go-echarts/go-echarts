...
type Toolbox struct {
	...
	Feature *ToolBoxFeature `json:"feature,omitempty,reserved"`
}
...
type ToolBoxFeature struct {
	// Save as image tool
	SaveAsImage *ToolBoxFeatureSaveAsImage `json:"saveAsImage,omitempty,reserved"`

	// Data brush
	Brush *ToolBoxFeatureBrush `json:"brush,omitempty,reserved"`

	// Data area zooming, which only supports rectangular coordinate by now.
	DataZoom *ToolBoxFeatureDataZoom `json:"dataZoom,omitempty,reserved"`

	// Data view tool, which could display data in current chart and updates chart after being edited.
	DataView *ToolBoxFeatureDataView `json:"dataView,omitempty,reserved"`

	// Restore configuration item.
	Restore *ToolBoxFeatureRestore `json:"restore,omitempty,reserved"`
}
...
type VisualMap struct {
	...
	Dimension primitive.Mixed `json:"dimension,omitempty"`
